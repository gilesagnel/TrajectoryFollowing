...
class ReplayBuffer():
    ...
    def __init__(self, max_size, env_dims=2, n_actions=2, image_shape=(1, 224, 224)):
        self.mem_size = max_size
        self.mem_cntr = 0
        self.image_state_memory = np.zeros((self.mem_size, *image_shape))
        self.env_state_memory = np.zeros((self.mem_size, env_dims))        self.env_state_memory = np.zeros((self.mem_size, env_dims))
